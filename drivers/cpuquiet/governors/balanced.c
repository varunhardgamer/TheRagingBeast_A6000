...
module_param(cpq_max_cpus, int, 0755);
...
static unsigned int  balance_level = 80;
static unsigned int  idle_bottom_freq = 200000;
static unsigned int  idle_top_freq = 800000;
static unsigned long up_delay = 90;
static unsigned long down_delay = 40;
static unsigned long last_change_time;
static unsigned int  load_sample_rate = 90; /* msec */
